...
| B10 | 2026-08-11 | Strict flake-manifest-check rejected the top-level `let` used to assemble the scaffold and project outputs | Return the recursive merge directly from `outputs`, with fragments supplied inline |
